...
using System.Linq;
using Xunit;
using static Common.Services.Database;

namespace CommonUnitTests.Models {

    public class ContactRepositoryTest : BaseTest, IDisposable {
        ...
        public ContactRepositoryTest() {
            DB.BeginTransaction();
            validator = A.Fake<IContactValidator>();
        ...
        public void SavesANewContact() {
            ...
            // when I save it
            A.CallTo(() => validator.IsValid(contact)).Returns(true);
        ...
        public void FailsToCreateDuplicateContact() {
            ...
            A.CallTo(() => validator.IsValid(newContact)).Returns(true);
